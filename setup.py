#!/usr/bin/env python3
# This file is part of the account_dunning_mipago module for Tryton.
...
download_url = 'https://github.com/tryton-ar/account_dunning_mipago/tree/%s' % branch
